...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = 'Name of the input artifact containing the raw sample data',
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = 'Minimum price allowed in the cleaned dataset',
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = 'Maximum price allowed in the cleaned dataset',
        required = True
    )
